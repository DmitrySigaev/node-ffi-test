...
#define DECL_EXCEPTION(ExceptionName) DECL_EXCEPTION2(ExceptionName, dnest::Exception)

#define DECL_EXCEPTION_NO_EXP2(ExceptionName, Parent) \
   class DECL_EXCEPTION_BODY(ExceptionName, Parent)

#define DECL_EXCEPTION_NO_EXP(ExceptionName) DECL_EXCEPTION_NO_EXP2(ExceptionName, dnest::Exception)
...
#define IMPL_EXCEPTION2(Namespace, ExceptionName, Parent, prefix) \
   ...
   Namespace::ExceptionName::~ExceptionName () {}                                      \
                                                                                       \
   dnest::Exception* Namespace::ExceptionName::clone ()                                \
   {                                                                                   \
...
#define IMPL_ERROR(Namespace, error_prefix) IMPL_ERROR2(Namespace, dnest::Exception, error_prefix)
